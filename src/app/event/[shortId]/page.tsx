                ...
                >
                  ...
                  >
                    <div className="text-[10px] sm:text-[11px] text-gray-500 leading-[1.6] space-y-1">
                      <p>상호명: 스마트 뉴비 | 사업장 소재지: 대전광역시 서구 둔산중로 74번길 42, 4층 407호 | 대표: 대표명 | 사업자 등록번호: 498-05-02914</p>
                      ...
                      <div className="flex flex-wrap gap-2 justify-center mt-2">
                        ...
                        <span>|</span>
                        <a href="https://ruby-composer-6d2.notion.site/1cd1bbec5ba180a3a4bbdf9301683145" target="_blank" rel="noopener noreferrer" className="hover:underline">개인정보 수집 및 이용동의</a>
                        <span>|</span>
                        <a href="https://ruby-composer-6d2.notion.site/1cd1bbec5ba1805dbafbc9426a0aaa80" target="_blank" rel="noopener noreferrer" className="hover:underline">서비스 이용약관</a>
                      </div>
                    </div>
                  </motion.div>
